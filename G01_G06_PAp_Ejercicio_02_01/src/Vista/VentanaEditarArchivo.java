...
public class VentanaEditarArchivo extends JInternalFrame  implements javax.swing.event.TreeSelectionListener
{
    ...
    private JLabel rutaActual=new JLabel();
     ...
     public VentanaEditarArchivo(GestionDato gD,DefaultTreeModel arbolD) {
