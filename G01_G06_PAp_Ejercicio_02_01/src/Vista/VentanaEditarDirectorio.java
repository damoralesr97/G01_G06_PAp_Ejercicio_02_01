 ...
 * @author paulo
 */
public class VentanaEditarDirectorio extends JInternalFrame  implements javax.swing.event.TreeSelectionListener
{
    ...
    public VentanaEditarDirectorio(GestionDato gD, DefaultTreeModel arbolD) {
